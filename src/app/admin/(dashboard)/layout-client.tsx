...
const NAV_GROUPS: {
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/pages/events", label: "Events Page", icon: Calendar, permission: "content.pages.edit", isActive: (p) => p === "/admin/pages/events" },
      { href: "/admin/pages/gallery", label: "Gallery Page", icon: ImageIcon, permission: "content.pages.edit", isActive: (p) => p === "/admin/pages/gallery" },
