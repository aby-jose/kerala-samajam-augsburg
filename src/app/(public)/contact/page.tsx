        ...
        <Container className="max-w-7xl">
          <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <SectionLead className="max-w-sm md:text-right">
              Everything here lands with the same handful of volunteers. Tell us
              what you need and we will point you at the right person.
            </SectionLead>
          </div>
      ...
      <section className="border-b border-border bg-surface-3 py-24 md:py-32">
        <Container className="max-w-7xl">
          <div className="mb-16 flex flex-col justify-between gap-8 md:flex-row md:items-end">
            ...
            <SectionLead className="max-w-sm md:text-right">
              The four we answer most weeks. If yours is not here, the form
            ...
            {[
              {
                ...
                a: (
                  <>
                    Most of what we do is open to everyone. A few evenings are
                    members-only, and the{" "}
                    <FaqLink href="/events">event page</FaqLink> always says so
                    before you register.
                  </>
                ),
              },
              {
                ...
                a: (
                  <>
                    Apply through the{" "}
                    <FaqLink href="/membership">membership page</FaqLink>. The
                    committee confirms it, and the year&apos;s invitations start
                    arriving from there.
                  </>
                ),
              },
              {
                q: "Can I bring the children?",
                a: (
                  <>
                    Always. There is usually a corner of the hall that belongs
                    entirely to them by the end of the evening.
                  </>
                ),
              },
              {
                q: "We have just moved to Augsburg.",
                a: (
                  <>
                    Then write anyway. Anmeldung, flats, schools, insurance —
                    someone here has done it recently and will walk you through
                    it.
                  </>
                ),
              },
        ...
        <Container className="relative">
          ...
          >
            <div className="flex justify-center">
              <Eyebrow tone="dark">Or simply turn up</Eyebrow>
            </div>

            <SectionTitle tone="dark" className="mt-7">
              Come Say Hello <Accent>In Person</Accent>
            </SectionTitle>

            <SectionLead tone="dark" className="mx-auto mt-6 max-w-xl">
              Most of our events are open to everyone, and the easiest
              introduction is to walk in and eat with us. No message required.
            </SectionLead>
...
/** An inline link inside an answer — underlined on the rule, not the text. */
