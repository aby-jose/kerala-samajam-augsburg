...
**Ruling F13 override:** do NOT edit `auth-actions.ts` — another party has uncommitted work in it and staging the file would sweep their changes into our commit. Leave its private copies in place; the new module documents the duplication for later removal. The original instruction was:
